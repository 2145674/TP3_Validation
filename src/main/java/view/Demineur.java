...
<<<<<<< Updated upstream:src/main/java/controller/Demineur.java
    extends JFrame
...
<<<<<<< HEAD:src/main/java/view/Demineur.java
...
=======
    ...
    private Component box1;
    private Component box4;
>>>>>>> tania:src/main/java/controller/Demineur.java

    private Icon sourire, oups, cool; //images du bouton
>>>>>>> Stashed changes:src/main/java/view/Demineur.java
